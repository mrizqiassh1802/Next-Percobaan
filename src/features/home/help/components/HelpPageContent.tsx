...
export default function HelpPageContent() {
  return (
    <Accordion type="single" collapsible className="mt-3 w-3/4 flex-1">
      <AccordionItem value="item-1">
        <AccordionTrigger>How to use this App?</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance">
          <div>
            <h3 className="text-lg font-bold">STEP 1</h3>
            <p>Influencers must register first.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold">STEP 2</h3>
            <p>Please wait for admin approval to complete the account creation process.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold">STEP 3</h3>
            <p>Once approved by the admin, your data will be published and displayed.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold">STEP 4</h3>
            <p>You can edit or update the submitted data at any time.</p>
          </div>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>Terms Of Services</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance">
          <p>
